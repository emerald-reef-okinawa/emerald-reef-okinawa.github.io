...
const LANGS = [
  ...
  },
  {
    ...
    ogDesc: '오키나와의 맑은 에메랄드빛 바다로. 완전 전세・무료 픽업・사진 최대 20장. 나하〜온나손 대응.'
  }
];
...
for (const L of LANGS) {
  ...
  const edits = [
    ...
    ['<title>エメラルドリーフ沖縄 | 沖縄シュノーケル・青の洞窟・スキンダイビング体験</title>',
      `<title>${L.title}</title>`],
    ['<meta name="description" content="沖縄の透き通ったエメラルドグリーンの海で完全貸切シュノーケル・青の洞窟・スキンダイビング体験。完全送迎付き・写真最大20枚プレゼント。那覇〜恩納村対応。" />',
    ...
    ['<meta property="og:description" content="沖縄の透き通ったエメラルドグリーンの海へ。完全貸切・完全送迎・写真最大20枚付き。那覇〜恩納村対応。" />',
    ...
    ['<meta name="twitter:description" content="沖縄の透き通ったエメラルドグリーンの海へ。完全貸切・完全送迎・写真最大20枚付き。" />',
